...
Language and compiler changes must preserve the reference programs' semantic tests and current cost envelopes unless an explicit design decision revises those contracts. The flagship proves the complete product; the references prevent the language from overfitting to it.
